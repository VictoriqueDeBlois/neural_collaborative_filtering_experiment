...
from origin_model import MLP, GMF
from origin_model.Dataset import Dataset
from origin_model.evaluate import evaluate_model
...
def get_model(num_users, num_items, mf_dim=10, layers=None, reg_layers=None, reg_mf=0):
...
def get_train_instances(train, num_negatives):
    ...
    num_users, num_items = train.shape[0]
